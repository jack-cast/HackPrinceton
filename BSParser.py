...
print('All Paths Lead to Philosophy \n \n By starting with a random page on Wikipedia, if you successively follow the '
      'first link on each page, you will end up on the Philosophy page in 98' + str('%') + ' of cases! \n')
...
def wiki(page):
    ...
    while page != 'Philosophy' and not (page in path):
        ...
        while sub_soup[new_index].isupper() or is_wiki != '/wiki/' or sub_soup[right_check:right_check + 4] == 'Help' or \
                        sub_soup[right_check:right_check + 4] == 'File' or sub_soup[
                                                                           right_check:right_check + 9] == 'Wikipedia' or \
                        sub_soup[right_check:right_check + 8] == 'Template' or sub_soup[
                                                                               right_check:right_check + 8] == 'Category':
...
page = str(input("Use 'e' to quit. \n \n Enter the title of a valid Wikipedia page and find your path to "
                 "Philosophy: "))
